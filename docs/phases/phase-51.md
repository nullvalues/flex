...
1. **Delegation** (Repo-E pattern): story files route the builder to the
...
2. **Duplication** (Repo-L pattern): phase doc contains full story specs inline
...
- Backfilling Repo-E phase docs to remove embedded story sections — out of scope;
