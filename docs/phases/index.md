...
| 140 | Fix silent YAML frontmatter truncation on embedded comment introducer (CER-211) | complete | [phase-140.md](phase-140.md) |
| 141 | Fix story_new.py writer/reader escaping mismatch (CER-213) | complete | [phase-141.md](phase-141.md) |
...
| 145 | Retire flex-harness release channel; merge fold-prep to main | complete | [phase-145.md](phase-145.md) |
| 146 | State-lifecycle relief: doctor-state, session-start orphan detection, gate-verdict invalidation | complete | [phase-146.md](phase-146.md) |
