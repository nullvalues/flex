...
| ID | Title | Status |
|----|-------|--------|
| INFRA-068 | CER-020: `exit_plan_mode.py` pipe-path containment guard | planned |
| INFRA-069 | `pairmode sync-build` — propagate CLAUDE.build.md template changes | planned |
