...
| RESOLVER-002 | Position-inference read-model (DP3, DP5) | complete |
| RESOLVER-003 | State machine + next-action subcommand (DP2, DP4, DP6) | complete |
| RESOLVER-004 | Isolation test suite (DP8) | complete |
