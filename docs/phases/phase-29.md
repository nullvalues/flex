...
| ID | Title | Status |
|----|-------|--------|
| INFRA-063 | Story frontmatter `source:` field — track drift-promoted vs anchor-native stories | planned |
| INFRA-065 | Project drift detection — `pairmode_drift_report.py` | planned |
