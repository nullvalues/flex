  ...
  skills/
    pairmode/                     ← /flex:pairmode — bootstrap and manage pairmode
      ...
      skills/
        ...
        spec-writer/
          procedure.md            ← plugin-versioned spec-writer procedure (WORKER-013, HARNESS005-main): bounded inputs (stub story file, phase doc, active era doc, one format exemplar), elaborates stub story in place (Ensures/Instructions/Tests/Out-of-scope), returns SPEC-RESULT{status: "done"|"revised"}; advisory-only until the flip (HARNESS006)
      scripts/
      ...
      templates/                  ← Jinja2 templates for scaffold generation
        ...
        agents/
          ...
          gate-worker.md.j2         ← thin gate-worker agent shell (WORKER-002, HARNESS002-main); delegates all judgment logic to skills/pairmode/gate_worker/SKILL.md; carries no inline gate-detection logic; advisory-only until the flip (HARNESS006)
        docs/
          brief.md.j2
